# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/20_datetime.ipynb.

# %% auto 0
__all__ = ['correct_week', 'arange_datetime', 'tow2datetime', 'datetime2tow', 'tow2zcount', 'zcount2tow', 'datetime2zcount',
           'zcount2datetime']

# %% ../nbs/20_datetime.ipynb 2
"""Copyright 2020 The Aerospace Corporation"""

# %% ../nbs/20_datetime.ipynb 5
import datetime
import numpy as np

from typing import Iterable, List, Tuple, Optional

# %% ../nbs/20_datetime.ipynb 6
_gps_epoch_datetime: datetime.datetime = datetime.datetime(1980, 1, 6)

# %% ../nbs/20_datetime.ipynb 8
